% django-template(SECTION) | User Commands
%
% "June 20 2024"
...
django-template - program to do something

# SYNOPSIS

**django-template** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**django-template** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **django-template** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**django-template** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    django-template. See **foo.conf**(5) for further details.
...
**django-template** provides some return codes, that can be used in scripts:
